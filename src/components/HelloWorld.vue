  ...
  <div class="hello">
    ...
    <div class="content">
      <ul v-loading.body="loading">
        <li :class="item.pid == '222'?'parent':'child'"
...
<script>
  ...
  export default {
    ...
    mounted () {
      // 取cookie
      this.openSimple = !this.$cookie.get('pinyinka70')
    },
    methods: {
      // logo的点击事件
      ...
      bClose () {
        ...
        this.$cookie.set('pinyinka70', 'Helloworld', parseInt(this.info.adInfo.interval))
      }
    }
  }
</script>
